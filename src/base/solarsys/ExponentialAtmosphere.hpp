...
protected: 
   enum
   {
      ...
      ExponentialAtmosphereParamCount
   };

   static const std::string
   PARAMETER_TEXT[ExponentialAtmosphereParamCount - AtmosphereModelParamCount];
   static const Gmat::ParameterType
   PARAMETER_TYPE[ExponentialAtmosphereParamCount - AtmosphereModelParamCount];
