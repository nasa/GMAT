...
#ifndef OVTOOFI_DEFS_HPP
#define OVTOOFI_DEFS_HPP
      ...
      #ifdef OVTOOFI_EXPORTS
         #define OVTOOFI_API __declspec(dllexport)
      #else
         #define OVTOOFI_API __declspec(dllimport)
      #endif
