...
\makeatletter
  \AddToShipoutPicture{%
    ...
    \setlength{\unitlength}{1pt}%
    \put(\strip@pt\@tempdimb,\strip@pt\@tempdimc){%
      \makebox(0,650){\rotatebox{0}{\textcolor[gray]{0.75}{\fontsize{0.9cm}{1.5cm}\selectfont{Draft for Release R2026a}}}}
    }
} \makeatother
...
Communications between Thinking Systems and Goddard Space Flight Center, May 9, 2004.
